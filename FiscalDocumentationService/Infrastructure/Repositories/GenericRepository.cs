...
namespace FiscalDocumentationService.Infrastructure.Repositories
{
    public class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        ...
        public GenericRepository(FiscalDocumentationDbContext context)
        {
            _context = context;
        ...
        public async Task<IEnumerable<T>> FindIncludingAsync(Expression<Func<T, bool>> predicate, params Expression<Func<T, object>>[] includes)
        {
