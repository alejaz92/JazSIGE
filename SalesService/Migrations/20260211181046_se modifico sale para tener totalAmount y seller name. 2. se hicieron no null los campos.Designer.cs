...
namespace SalesService.Migrations
{
    ...
    [Migration("20260211181046_se modifico sale para tener totalAmount y seller name. 2. se hicieron no null los campos")]
    partial class semodificosaleparatenertotalAmountysellername2sehicieronnonullloscampos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalesService.Infrastructure.Models.Sale.DeliveryNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SalesService.Infrastructure.Models.Sale.DeliveryNote_Article", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DeliveryNoteArticles");
                });
            ...
            modelBuilder.Entity("SalesService.Infrastructure.Models.Sale.Sale", b =>
                {
                    ...
                    b.Property<int?>("CustomerPostalCodeId")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("HasStockWarning")
                        .HasColumnType("bit");
                    ...
                    b.Property<DateTime?>("StockWarningUpdatedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("SalesService.Infrastructure.Models.Sale.SaleStockWarning", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("ShortageSnapshot")
                        .HasColumnType("decimal(18,4)");
            ...
            modelBuilder.Entity("SalesService.Infrastructure.Models.Sale.DeliveryNote_Article", b =>
                {
                    b.HasOne("SalesService.Infrastructure.Models.Sale.DeliveryNote", "DeliveryNote")
                        .WithMany("Articles")
